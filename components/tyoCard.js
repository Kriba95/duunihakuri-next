          ...
          <div className="box-border mx-4 max-w-full sm:columns-2 md:columns-2 lg:columns-4 xl:columns-5 gap-4">
            ...
            <div className="flex flex-col break-inside bg-white rounded-xl p-4 mb-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <a
                  href="#"
                  className="no-underline rounded-full p-2 transition-all hover:bg-slate-100"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="col-start-2 row-start-1 row-end-3 sm:mt-4 lg:mt-0 xl:mt-4">
                ...
                <dd className="flex justify-start -space-x-1.5">
                  <a href="#" className="inline-block -m-1">
                    <img
                      className="w-9 h-9 rounded-full bg-slate-100 ring-2 ring-white dark:ring-slate-700 dark:group-hover:ring-white"
            ...
            <div className="break-inside bg-white rounded-xl p-4 mb-4">
              <div className="flex items-center space-x-4 md:space-x-3">
                <div className="flex-none">
                  <button
                    type="button"
                    className="inline-flex items-center justify-center rounded-full w-12 h-12 bg-cyan-400"
                  >
                    <svg
                      className="w-7 h-7"
                      viewBox="0 0 15 15"
                ...
                <div className="min-w-0 flex-auto">
                  ...
                  <p className="truncate mb-2 text-sm text-slate-600">
                    Lorem ipsum dolor sit consectetur permi...
                  </p>
            ...
            <a
              href="#"
              className="break-inside flex bg-gradient-to-r from-[#ec00d8] to-[#A649EE] rounded-xl p-4 mb-4 text-white"
            >
              <div className="flex items-start space-x-4">
                <img
                  className="flex-none w-14 h-14 rounded-full object-cover"
                ...
                <div className="flex-auto">
                  ...
                  <p className="text-sm">
                    lorem ipsum dolor sitIn nisi quis nostrud minim.
                  </p>
                </div>
              </div>
            </a>
            ...
            <div className="break-inside flex items-center space-x-4 bg-white rounded-xl overflow-hidden pr-4 mb-4">
              ...
              />
              <div className="flex-auto">
                <a href="#" className="no-underline font-bold block text-xl">
                  Maria
                </a>
              </div>
            ...
            <div className="break-inside flex items-center space-x-4 bg-white rounded-xl overflow-hidden pr-4 mb-4">
              ...
              <button className="inline-flex justify-center items-center rounded-md py-2 px-4 font-medium tracking-wide text-sm transition-all bg-violet-500 text-white hover:bg-violet-600 active:bg-violet-700">
                Button
              </button>
            </div>
            <div className="break-inside flex items-center justify-between bg-white rounded-xl p-4 mb-4">
 ...
 */}
            ...
            <a
              href="#"
              className="break-inside overflow-hidden flex bg-gradient-to-r from-[#EC008C] to-[#FC6767] rounded-xl mb-4"
            >
              <div className="flex-1 items-center relative">
                <div className="absolute -right-3 -top-1">
                  <img
                    className="flex-none w-24 h-24 rounded-2xl object-cover rotate-6"
            ...
            <div className="break-inside flex items-center justify-between bg-white rounded-xl p-4 mb-4">
              ...
              <div className="flex flex-col items-center">
                <img
                  className="w-8 h-8"
                  src="https://www.svgrepo.com/show/287721/cloudy-sun-rays.svg"
                />
              </div>
            </div>
            <div className="break-inside bg-white rounded-xl p-4 mb-4">
              <div className="flex items-center">
                ...
                <div className="flex-auto text-center space-y-1">
                  <img
                    className="w-8 h-8 m-auto"
                    src="https://www.svgrepo.com/show/400800/sunraincloud.svg"
                  />
                ...
                <div className="flex-auto text-center space-y-1">
                  <img
                    className="w-8 h-8 m-auto"
                    src="https://www.svgrepo.com/show/400797/sunbehindcloud.svg"
                  />
                ...
                <div className="flex-auto text-center space-y-1">
                  <img
                    className="w-8 h-8 m-auto"
                    src="https://www.svgrepo.com/show/402761/sun-behind-small-cloud.svg"
                  />
            ...
            <a
              href="#"
              className="break-inside flex flex-row items-center justify-between bg-gradient-to-r from-[#FF512F] to-[#DD2476] rounded-xl p-4 mb-4"
            >
              ...
              >
                ...
                ></path>
                <circle className="fill-[#FFE600]" cx={16} cy={16} r={9} />
                <path
                  className="fill-white stroke"
                  d="M28 20c-.825 0-1.62.125-2.369.357A6.498 6.498 0 0 0 19.5 16c-3.044 0-5.592 2.096-6.299 4.921A4.459 4.459 0 0 0 10.5 20A4.5 4.5 0 0 0 6 24.5c0 .604.123 1.178.339 1.704A4.98 4.98 0 0 0 5 26c-2.762 0-5 2.238-5 5s2.238 5 5 5h23a8 8 0 1 0 0-16z"
                ></path>
              </svg>
            </a>
