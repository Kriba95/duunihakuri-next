...
//   const [propsse, setPropsse] = useState(false);
let propsse = false;

  const router = useRouter();
  let id = router.query.id;

  //   // Handle Change Value Passor
  //   if (id !== undefined) {
  ...
  function handleChange(evt, propsse) {
    console.log(propsse);
    console.log(evt);
  ...
  if (propsse === false) {
    ...
    console.log("neekeri");
    let ids = parseFloat(router.query.id);
    console.log(ids);
    propsse = true
    // setPropsse(true);
    console.log(propsse);
    handleChange(ids, propsse);
  } else {
    console.log("error");
  }
